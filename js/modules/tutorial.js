...
const STEPS = {
    ...
    el: [
        ...
        { element: '#tab-vault', popover: { title: 'THE VAULT', description: 'Πρόσβαση σε απόρρητα συστήματα που είναι είτε εξαντλημένα είτε έρχονται σύντομα. Πρόσεχε για θρυλικά drops.', side: "bottom", align: 'start' } },
